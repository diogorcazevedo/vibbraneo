    ...
    useEffect(() => {
        const getData = async () => {
            ...
            try {
                ...
                const response = await api.get('/message/getById/'+params.message);
                setMsn(response.data.message)
                setLoading(false);
            } catch (error) {
                setLoading(true);
        ...
        <>
            ...
            {!loading &&
                <div className="space-y-10 divide-y divide-gray-900/10">
                    <div className="px-6">
                        <h3 className="text-2xl leading-6 text-green-700">Mensagem</h3>
                    </div>
                        ...
                        <form className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                            <div className="px-4 py-6 sm:p-8">
                                <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    {/*        <span*/}
                                    {/*            className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">Produto: </span>*/}
