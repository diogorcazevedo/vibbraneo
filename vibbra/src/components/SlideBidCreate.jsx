...
import {FormBid} from "@/components/forms/FormBid";



export default function SlideBidCreate({deal,user}) {
                                            ...
                                            <div className="bg-gray-50 px-4 py-6 sm:px-6">
                                                <div className="flex items-start justify-between space-x-3">
                                                    <div className="space-y-1">
                                                        <Dialog.Title className="text-lg font-medium text-gray-900"> Proposta de troca </Dialog.Title>
                                                    </div>
                                                ...
                                                <div className="bg-white ">
                                                    <div className="px-6 py-2">
                                                        <div className="bg-white shadow-sm ring-1 ring-gray-900/5 px-4 py-4">
                                                            <h3 className="text-base font-semibold leading-6 text-gray-900">Formatar Proposta</h3>
                                                            <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                                                                <div className="max-w-xl text-sm text-gray-500">
                                                                    <p>
                                                                       Este ambiente permite que o interessado faça uma proposta de troca para o proprietário do equipamento
                                                                    </p>
                                                                    <p>
                                                                        Em caso de aprovação o painel exibirá o status como aceita/aprovada
                                                                    </p>
                                                                    <p>
                                                                        Caso a aprovação não apareça no sistema, o interessado poderá realizar nova proposta
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
